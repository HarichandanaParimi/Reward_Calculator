...
import com.rewards.model.RewardsData;
...
public class RewardsService {
	...
	public Response calculateRewards(List<Transaction> transactions) {
		...
		List<RewardsData> rewardsData = new ArrayList<RewardsData>();
		response.setRewardsData(rewardsData);
		...
		for (String customer : customerTransactionMap.keySet()) {
			...
			RewardsData customerData = new RewardsData();
